...
public class Tower3 extends GameObject 
{
	int a = 0;
	...
	static 
	{
		Image[] imgs = new Image []
				{
				tk.getImage(BackGroundImage.class.getClassLoader().getResource("Img/tower3.png")),
				};
		obj_imgs.put("T1", imgs[0]);
	}

	public Tower3(int x, int y,GamePanel gp) {
		super(x, y, gp);
		obj_w=150;
		obj_h=95;
		all_w=150;
